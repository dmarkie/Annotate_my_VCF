...
echo "AnnoBCSQ on $(date) on $(hostname)"
echo "$0 $*"
...
if [ -f ${PROJECT_PATH}/done/bcsq/$(basename ${output}).done ]
then
...
if [ -f ${PROJECT_PATH}/done/bcsq/$(basename ${output}).tbi.done ]
 then
